...
// Definujeme typy pro parametry stránky
type AboutPageProps = {
  params: { locale: string };
}

export async function generateStaticParams() {
  // Definujte všechny podporované jazyky
  const locales = ['cs', 'en']; // Upravte podle vašich podporovaných jazyků
...
export default async function About({ params }: AboutPageProps) {
  ...
  // Použijeme getTranslations místo useTranslations
  const t = await getTranslations();
